...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public List<CustomerModel> getAllRecords(){
        ...
        if(cursor.moveToFirst())
        {
            do{
                ...
                CustomerModel newCustomer = new CustomerModel(customerName, customerAge, isActive, customerId);
    ...
    public void deleteCustomer(int id){
        ...
        SQLiteDatabase DB =this.getReadableDatabase();
        String[] arguments = {String.valueOf(id)};//customer id
        DB.delete(CUST_TABLE,"CustomerID = ?", arguments);//deleting customer by its id
        DB.close();
